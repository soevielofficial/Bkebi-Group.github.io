...
### Buka menu tim secara cepat

Tidak akan ada lagi waktu tunggu 2 detik di luar pertempuran saat membuka konfigurasi tim.

![Open_Team_Immediately.gif](_images/World/Open_Team_Immediately.gif)

### Lewati animasi penguatan

Lewati dialog naik level untuk senjata dan artifak.
